...
2. **Setup (2–3 min).** The client: WoW: Forever build 69913, most legacy Lua
...
3. **The four errors (16–22 min, roughly equal time).**
...
4. **The turn (4–6 min).** What did *not* catch these. Not reasoning — every
...
5. **Implications (4–6 min).** Both lazy conclusions are wrong. "Don't trust
...
6. **Close (1 min).** The discipline is structural, not attitudinal: build the
...
**30–40 minutes.** Consistent with the Runtime Reality back catalogue. Do not
pad. If short on material, go deeper on the four errors rather than adding
scope.

### Hard accuracy rules

- **Every figure must come from the fact sheet.** If a number is not in the
  sources, say so out loud — "the sources don't give that figure" — rather than
  producing one.
- Do not round. It is **392 bytes**, not "about 400". It is **ASCII 31**, not
  "a control character in the thirties". It is **build 69913**.
- The **"Things that are NOT true"** section of the fact sheet is a blocklist.
  Do not state any of those, even as a passing aside or a setup line.
...
Analytical and specific, matching the Musings of My Today house style: lead
with verified data, puncture the comfortable assumption, resist the moral.
Dry humour is welcome where earned — the ASCII 31 story is genuinely funny
because the textbook answer is the one that fails.

Avoid: hype, "game-changer", "revolutionise", breathless AI-doom or AI-boosterism.
The interesting claim is narrow and technical. Keep it narrow.

### Explicitly out of scope

- The addon's feature list
- UI layout decisions, frame strata, window layering
- Packaging and licensing
- Anything about publishing or CurseForge

These happened; they are not this episode.
