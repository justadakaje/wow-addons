...
3. For addons that use the WoW API, this repo assumes the `wow-api-mcp` MCP server is attached (Claude Desktop or Claude Code) so API calls are verified against real signatures rather than guessed. See `AGENTS.md`.
